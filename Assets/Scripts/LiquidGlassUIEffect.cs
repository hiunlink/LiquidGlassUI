...
{
    [Header("LiquidGlass SDF")]
    [Tooltip("Corner radius in pixels (UI designer units)")]
    ...
    [Header("Blur")] 
    public BlurEffectType blurAlgorithm = BlurEffectType.MipMapChain;
    [Range(0,8)]    
    public float mipMapLod = 1.4f;
    ...
    [Header("Advanced")]
    [Tooltip("Update parameters every LateUpdate (useful if animating size via layout)")]
    ...
    void EnsureMaterialAssigned()
    {
        ...
        bool shouldReplace = (curr == null) || (curr.shader == null) ||
                             currName == "UI/Default" || currName == "Sprites/Default" || currName == "TextMeshPro/Distance Field" ||
